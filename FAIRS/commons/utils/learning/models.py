...
from FAIRS.commons.utils.learning.transformers import TransformerEncoder, NumberPredictor, ColorPredictor
...
class FAIRSnet: 
    ...
    def get_model(self, summary=True):                
        ...
        predicted_numbers = self.number_predictor(embeddings)    
        predicted_colors = self.color_predictor(embeddings) 
