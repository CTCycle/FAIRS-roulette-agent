...
call pip install tensorflow==2.19.0
call pip install keras==3.10.0 scikit-learn==1.6.1 
call pip install numpy==2.1.3 pandas==2.2.3 tqdm==4.67.1 matplotlib==3.10.1  
