...
if parameters['Model name'] == 'CCM':
    if parameters['Class encoding'] == True:
        ...
        CCM_timeseries = df_predictions['encoding']
    predictions_inputs, CCM_outputs = PP.timeseries_labeling(CCM_timeseries, parameters['Window size'], 
                                        parameters['Output seq length'])
    
elif parameters['Model name'] == 'PMM':
    pass
...
# predict using pretrained model CCM
#------------------------------------------------------------------------------ 
if parameters['Model name'] == 'CCM':
